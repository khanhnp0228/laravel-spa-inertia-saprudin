                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-6">
                                        ...
                                        <input type="text" name="name" v-model="form.name" id="name"
                                            ...
                                            :class="{ 'bg-gray-50 border border-gray-300 text-gray-900': !form.errors.name, 'bg-red-50 border border-red-500 text-red-900': form.errors.name }" />
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" name="brand" v-model="form.brand" id="brand"
                                            class="shadow-sm text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                            :class="{ 'bg-gray-50 border border-gray-300 text-gray-900': !form.errors.brand, 'bg-red-50 border border-red-500 text-red-900': form.errors.brand }" />
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <select name="category_id" v-model="form.category_id" id="category_id"
                                            class="shadow-sm text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                            :class="{ 'bg-gray-50 border border-gray-300 text-gray-900': !form.errors.category_id, 'bg-red-50 border border-red-500 text-red-900': form.errors.category_id }">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="number" name="price" v-model="form.price" id="price"
                                            class="shadow-sm text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                            :class="{ 'bg-gray-50 border border-gray-300 text-gray-900': !form.errors.price, 'bg-red-50 border border-red-500 text-red-900': form.errors.price }" />
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="number" name="stocks" v-model="form.weight" id="stocks"
                                            ...
                                            :class="{ 'bg-gray-50 border border-gray-300 text-gray-900': !form.errors.weight, 'bg-red-50 border border-red-500 text-red-900': form.errors.weight }" />
                                    ...
                                    <div class="col-span-6 sm:col-span-6">
                                        ...
                                        <textarea name="description" v-model="form.description" id="description"
                                            class="shadow-sm text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                            :class="{ 'bg-gray-50 border border-gray-300 text-gray-900': !form.errors.description, 'bg-red-50 border border-red-500 text-red-900': form.errors.description }" rows="3"></textarea>
